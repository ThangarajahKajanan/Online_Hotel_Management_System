				...
				<form name="insert" action="insertExpense" method="post">
					...
					<fieldset class="form-group">
						<label>Date</label> <br> <input type="text" name="date"
							id="datepicker" class="form-control"> <br>
					</fieldset>

					<fieldset class="form-group">
						<label>Division</label>
						 <select id="div" name="division"
							class="form-control">
					...
					<fieldset class="form-group">
						<label>Type</label><br> <input type="text" name="type"
					...
					<fieldset class="form-group">
						<label>Total</label> <br> <input type="text" name="total"
							class="form-control" id="total" onkeypress="isInputNumber(event)">
					</fieldset>

					<button type="submit" name="submit" onClick="return validate();"
						class="btn-xl btn-outline-dark">Add Expense</button>
				</form>
			</div>
		</div>
	</div>
