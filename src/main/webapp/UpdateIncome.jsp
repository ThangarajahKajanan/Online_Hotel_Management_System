			...
			<div class="card-body">
				<form action = "UpdateIncome" method = "post">
					...
					<fieldset class="form-group">
						...
						<input type = "text" name = "remarks" class="form-control" value ="<%= remarks %>"> <br>
					</fieldset>
	
					<button type ="submit" name = "submit" onClick = "return validate();" class="btn-xl">Update Income</button>
				</form> 
			</div>
		</div>
	</div>
